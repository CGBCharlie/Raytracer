...
/**
 * this class receives attributes from the object3D class, this class will create an sphere with the parameters passed
 * like the radius, the color and the position, it overrides the intersection method because a ray thrown to the sphere will
 * bounce differently from other objects.
 */
