...
/**
 * this class receives attributes from the object3D class, this class will create the desired triangles to form
 * an object made of this triangles, with the desired attributes, position, color, and material, this class will be
 * used by the OBJReader to create any model inside the raytracer.
 */
