...
/**
 * this class receives attributes from the object3D class, this class creates the field of view of
 * the image, receives the resolution and establishes a limit of pixels rendered using a near and
 * far plane, from this object all the starting rays will be thrown to check every pixel inside the planes.
 */
